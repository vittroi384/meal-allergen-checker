...
var COLUMN_WIDTHS = Object.freeze({
  // 학생 / 템플릿
  '학년도': 70, '학년': 55, '반': 55, '이름': 100, '담임이름': 100, '담임전화번호': 140, '알레르기코드': 140, '기타알레르기': 170, '비고': 280,
  '학부모이메일': 230, '학부모연락처': 140, '학부모알림': 95, '사용여부': 80,
  // 급식
  '날짜': 110, '식사구분': 85, '메뉴명': 240, '출처': 75, '수동수정여부': 110, '원본문자열': 300, '확인시각': 130,
  // 알림로그
...
var TEXT_FORMAT_HEADERS = Object.freeze(['날짜', '대상일', '발송시각', '알레르기코드', '학부모연락처', '담임전화번호', '중복키', '값']);
...
/** 가운데 정렬할 짧은 열 */
var CENTER_HEADERS = Object.freeze(['학년도', '학년', '반', '학부모알림', '사용여부', '날짜', '식사구분', '출처', '수동수정여부', '채널', '종류', '대상일', '성공여부']);
